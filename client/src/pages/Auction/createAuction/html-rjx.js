...
// import MultiImageUpload from './multiUploader'
...
function HtmlRjx(){
    ...
    return (
        ...
        <MKTypography textGradient color sx={customStyle.title}> Create Auction</MKTypography>
        <div id="main">
                                    ...
                                    <div className="c-car-detail__module u-no-border-top">
                                                            ...
                                                            <div className="o-level__item">
                                                                <div className="c-stat">
                                                                    ...
                                                                    <div className="c-stat__value c-stat__value--large">
                                                                        <font style={{verticalAlign: 'inherit'}}>
                                                                            <font style={{verticalAlign: 'inherit'}}>NOK 1000</font>
                                                                        </font>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div className="u-margin-bottom">
                                                                <div className="c-input-increment">
                                                                    ...
                                                                    <div className="c-input-increment__wrapper">
                                                                        <input  type="price" placeholder="Amount" style={customStyle.rightSideInput}/>
                                                                    </div>
                                                                ...
                                                                <div className="o-level o-level--centered">
                                                                    <span className="u-h8 u-margin-top-tiny">
                                                                        <font style={{verticalAlign: 'inherit'}}>
                                                                            ...
                                                                            <font style={{verticalAlign: 'inherit'}}>minimum: 10000 </font>
                                                                            <font style={{verticalAlign: 'inherit'}}>)</font>
                                                                        </font>
                                        ...
                                        <div className="c-car-detail__module">
                                            <div className="o-level o-level--spaced u-margin-bottom">
                                                ...
                                                <h3 className="u-h4 u-text-bolder">
                                                    <font style={{verticalAlign: 'inherit'}}><font style={{verticalAlign: 'inherit'}}>0 bids</font></font>
                                                </h3>
                                            </div>
