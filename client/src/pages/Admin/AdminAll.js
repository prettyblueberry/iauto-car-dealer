...
import { update, remove } from 'api/auction';
...
const columns = [
    ...
    { field: 'seller',   headerName: 'Seller', width: 120 , hide: false, align:"center", type:'string', editable: false},
    { field: 'winnerId',   headerName: 'WinnerId', width: 120 , hide: true, align:"center", type:'string', editable: false},
    { field: 'winner',   headerName: 'Winner', width: 120 , hide: false, align:"center", type:'string', editable: false},
];
